...
<button class="custom-button hint" onclick="toggleAlert(event, 'Calculer la bonne valeur critique.', 'hint')"> ❓ Indice </button><div class="alert alert-info" style="display: none;"> <strong class="alertType"></strong>: <span class="alertMessage"></span> </div> <div style="margin-top: 4px;"></div>
