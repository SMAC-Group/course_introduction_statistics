...
<!-- Button for Explanation -->
<button class="custom-button explanation" onclick="toggleAlert(event, 'Les paires de dés donnant une somme de \\(8\\) sont \\((2,6), (6,2), (3,5), (5,3), (4,4) \\). Parmi elles, \\(2\\) ont un \\(6\\), soit \\(\\frac{2}{4} = \\frac{1}{2}\\).', 'explanation')">
  💡 Explication
</button>
<div class="alert alert-info" style="display: none;">
  <strong class="alertType"></strong>: <span class="alertMessage"></span>
