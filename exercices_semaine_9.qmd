...
À partir de la statistique de test calculée précédemment, déterminez la p-valeur associée au test (bilatéral) au niveau de signification \\(\\alpha = 0.05\\).
...
```{r}
opts <- c(
  "On rejette \\(H_0\\) : il y a suffisamment d'évidences pour conclure que la proportion réelle est différente de \\(50\\%\\).",
  "On accepte \\(H_0\\) : la proportion réelle est exactement de \\(50\\%\\).",
  answer = "On ne rejette pas \\(H_0\\) : il n’y a pas suffisamment d'évidences.",
